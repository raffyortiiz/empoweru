...
{
 $sub_array = array();
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["hrID"].'" data-column="username">' . $row["username"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["hrID"].'" data-column="password">' . $row["password"] . '</div>';
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["hrID"].'" data-column="email">' . $row["email"] . '</div>';
  $sub_array[] = '<button type="button" name="delete" class="btn btn-danger btn-xs delete" hrID="'.$row["hrID"].'">Delete</button>';
 $data[] = $sub_array;
}
